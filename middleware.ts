...
const isPublicRoute = createRouteMatcher([
  ...
  "/__clerk(.*)",
  // Vercel Blob's upload-completed callback carries no browser session.
  // The route authenticates itself: token requests need getSession(), and
  // completion callbacks are signature-verified by handleUpload.
  "/api/blob/upload",
]);
